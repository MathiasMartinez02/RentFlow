...
export function PaymentsView() {
  ...
  return (
    <RoleGuard resource="payments" showFallback>
      <>
        <div className="flex flex-col gap-6">
          ...
          {!isLoading && payments.length === 0 ? (
            ...
            <PaymentTable
              ...
              isLoading={isLoading}
              onView={openPaymentDrawer}
              onEdit={canEdit("payments") ? openPaymentForm : undefined}
              onDelete={canDelete("payments") ? deletePayment : undefined}
            />
          )}
        </div>
        ...
        <PaymentDrawer
          ...
          onEdit={canEdit("payments") ? (id) => { closePaymentDrawer(); openPaymentForm(id); } : undefined}
          onDelete={canDelete("payments") ? deletePayment : undefined}
        />
