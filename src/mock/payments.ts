...
// Today = 2026-05-19
// Tenants: ten-001 $3200 · ten-002 $2100 · ten-003 $4500 · ten-004 $3800 · ten-005 $6200
...
export const MOCK_PAYMENTS: Payment[] = [
  // ─── Diciembre 2025 ─────────────────────────────────────────────────────
  {
    ...
    amount: 3200, dueDate: "2025-12-05", paidDate: "2025-12-04",
  ...
  },
  {
    ...
    period: "2025-12", concept: "Alquiler Diciembre 2025",
    amount: 2100, dueDate: "2025-12-05", paidDate: "2025-12-09",
  ...
  },
  {
    ...
    period: "2025-12", concept: "Alquiler Diciembre 2025",
    amount: 4500, dueDate: "2025-12-01", paidDate: "2025-12-01",
  ...
  },
  {
    ...
    period: "2025-12", concept: "Alquiler Diciembre 2025",
    amount: 3800, dueDate: "2025-12-05", paidDate: "2025-12-05",
  ...
  },
  {
    ...
    period: "2025-12", concept: "Alquiler Diciembre 2025",
    amount: 6200, dueDate: "2025-12-10", paidDate: "2025-12-08",
  ...
  // ─── Enero 2026 ─────────────────────────────────────────────────────────
  {
    ...
    amount: 3200, dueDate: "2026-01-05", paidDate: "2026-01-04",
  ...
  },
  {
    ...
    period: "2026-01", concept: "Alquiler Enero 2026",
    amount: 2100, dueDate: "2026-01-05", paidDate: "2026-01-08",
    status: "paid", method: "cash",
    createdAt: "2025-12-29T10:00:00Z",
  },
  {
    ...
    period: "2026-01", concept: "Alquiler Enero 2026",
    amount: 4500, dueDate: "2026-01-01", paidDate: "2026-01-01",
  ...
  },
  {
    ...
    period: "2026-01", concept: "Alquiler Enero 2026",
    amount: 3800, dueDate: "2026-01-05", paidDate: "2026-01-05",
  ...
  },
  {
    ...
    period: "2026-01", concept: "Alquiler Enero 2026",
    amount: 6200, dueDate: "2026-01-10", paidDate: "2026-01-09",
  ...
  // ─── Febrero 2026 ────────────────────────────────────────────────────────
  {
    ...
    amount: 3200, dueDate: "2026-02-05", paidDate: "2026-02-05",
  ...
  },
  {
    ...
    period: "2026-02", concept: "Alquiler Febrero 2026",
    amount: 2100, dueDate: "2026-02-05", paidDate: "2026-02-22",
    status: "paid", method: "cash",
    lateFee: 210,
    notes: "Pago realizado con 17 días de mora. Se aplicó cargo por mora del 10%.",
    createdAt: "2026-01-28T10:00:00Z",
  },
  {
    id: "pay-013", contractId: "con-003", tenantId: "ten-003", propertyId: "prop-003",
    period: "2026-02", concept: "Alquiler Febrero 2026",
    amount: 4500, dueDate: "2026-02-01", paidDate: "2026-01-31",
  ...
  },
  {
    ...
    period: "2026-02", concept: "Alquiler Febrero 2026",
    amount: 3800, dueDate: "2026-02-05", paidDate: "2026-02-06",
  ...
  },
  {
    ...
    period: "2026-02", concept: "Alquiler Febrero 2026",
    amount: 6200, dueDate: "2026-02-10", paidDate: "2026-02-10",
  ...
  // ─── Marzo 2026 ──────────────────────────────────────────────────────────
  {
    ...
    amount: 3200, dueDate: "2026-03-05", paidDate: "2026-03-04",
  ...
  },
  {
    ...
    period: "2026-03", concept: "Alquiler Marzo 2026",
    amount: 2100, dueDate: "2026-03-05", paidDate: "2026-03-19",
  ...
  },
  {
    ...
    period: "2026-03", concept: "Alquiler Marzo 2026",
    amount: 4500, dueDate: "2026-03-01", paidDate: "2026-03-01",
  ...
  },
  {
    ...
    period: "2026-03", concept: "Alquiler Marzo 2026",
    amount: 3800, dueDate: "2026-03-05", paidDate: "2026-03-05",
  ...
  },
  {
    ...
    period: "2026-03", concept: "Alquiler Marzo 2026",
    amount: 6200, dueDate: "2026-03-10", paidDate: "2026-03-08",
  ...
  // ─── Abril 2026 ──────────────────────────────────────────────────────────
  {
    ...
    amount: 3200, dueDate: "2026-04-05", paidDate: "2026-04-03",
  ...
  },
  {
    ...
    period: "2026-04", concept: "Alquiler Abril 2026",
    amount: 2100, paidAmount: 1500,
    dueDate: "2026-04-05", paidDate: "2026-04-18",
    status: "partial", method: "cash",
    notes: "Pago parcial. Saldo pendiente: $600. Inquilino comprometió saldo para el 30/04.",
    createdAt: "2026-03-28T10:00:00Z",
  },
  {
    id: "pay-023", contractId: "con-003", tenantId: "ten-003", propertyId: "prop-003",
    period: "2026-04", concept: "Alquiler Abril 2026",
    amount: 4500, dueDate: "2026-04-01", paidDate: "2026-04-01",
  ...
  },
  {
    ...
    period: "2026-04", concept: "Alquiler Abril 2026",
    amount: 3800, dueDate: "2026-04-05", paidDate: "2026-04-04",
  ...
  },
  {
    ...
    period: "2026-04", concept: "Alquiler Abril 2026",
    amount: 6200, dueDate: "2026-04-10", paidDate: "2026-04-09",
  ...
  // ─── Mayo 2026 (mes actual · hoy = 2026-05-19) ────────────────────────────
  {
    ...
    amount: 3200, dueDate: "2026-05-05",
    status: "overdue",
  ...
  },
  {
    ...
    period: "2026-05", concept: "Alquiler Mayo 2026",
    amount: 2100, dueDate: "2026-05-05",
    status: "overdue",
  ...
  },
  {
    ...
    period: "2026-05", concept: "Alquiler Mayo 2026",
    amount: 4500, dueDate: "2026-05-01", paidDate: "2026-05-01",
  ...
  },
  {
    ...
    period: "2026-05", concept: "Alquiler Mayo 2026",
    amount: 3800, dueDate: "2026-05-20",
    status: "pending",
    createdAt: "2026-04-28T10:00:00Z",
  },
  {
    ...
    period: "2026-05", concept: "Alquiler Mayo 2026",
    amount: 6200, dueDate: "2026-05-10", paidDate: "2026-05-08",
...
// Legacy — usado por tenant-drawer; no modificar su tipo
...
// Re-export the old type alias for backward compat
